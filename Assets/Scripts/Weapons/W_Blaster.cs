...
public class W_Blaster : Weapons
{
	[Header("Sprites for animation")]
	public Sprite idleBlaster;
	public Sprite shot1Blaster, shot2Blaster, shot3Blaster, shot4Blaster;
	...
	void FixedUpdate() 
	{
		...
		{
			isShot = false;
			DynamicCrosshair.spread += DynamicCrosshair.BLASTER_SHOOTING_SPREAD;
			ammoClipLeft--;
	...
	IEnumerator ShotAnimation()
	{
		...
		spriteRenderer.sprite = shot1Blaster;
		yield return new WaitForSeconds(0.025f);
		spriteRenderer.sprite = shot2Blaster;
		yield return new WaitForSeconds(0.025f);
		spriteRenderer.sprite = shot3Blaster;
		yield return new WaitForSeconds(0.025f);
		spriteRenderer.sprite = shot4Blaster;
		yield return new WaitForSeconds(0.025f);
		spriteRenderer.sprite = idleBlaster;
	}	
}
